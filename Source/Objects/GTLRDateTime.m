...
- (NSString *)RFC3339String {
  ...
  if (self.hasTime) {
    ...
    if (offsetMinutes) {
      ...
      timeString = [NSString stringWithFormat:@"T%02ld:%02ld:%02zd%@%@",
  ...
  // full dateString like "2006-11-17T15:10:46-08:00"
    NSString *dateString = [NSString stringWithFormat:@"%04ld-%02zd-%02zd%@",
                            (long)dateComponents.year, (long)dateComponents.month, (long)dateComponents.day, timeString];
